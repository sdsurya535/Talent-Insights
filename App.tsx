      ...
      <div className="flex flex-1 relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
          ...
          <footer className="bg-white border-t p-4 md:p-6">
            <div className="flex flex-col lg:flex-row items-center justify-between text-[11px] md:text-xs text-gray-500 max-w-7xl mx-auto w-full gap-4">
              ...
              <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 font-medium">
                ...
                <button onClick={() => notify("Changing Language")} className="hover:underline hover:text-blue-600 transition-colors flex items-center">
